...
if __name__ == '__main__':
    ...
    # led.colorWipe(int(argv[2]), int(argv[1]),int(argv[3]))
    # time.sleep(4)
    VERDE = int(argv[1])
    ROSSO = int(argv[2])
    BLU = int(argv[3])
    led.colorWipe(ROSSO,VERDE, BLU)
    time.sleep(4) 
    print("Accesi tutti i LED")
    led.colorWipe(0,0,0)
    ...
    # SCAMBIO ROSSO E VERDE e così mi conformo al client..:
    # RICORDA: argv[] = nomeProgramma, arg1, arg2, ..., argN



    print("Numero di argomenti passati: " , len(sys.argv))
    ...
    if len(argv) == 2:
        ...
        if len(argv) == 4:
            # accendiTuttiLED(ROSSO, VERDE, BLU)
            # VERDE = int(argv[1])
            # ROSSO = int(argv[2])
            # BLU = int(argv[3])
            # led.colorWipe(ROSSO,VERDE, BLU)
        ...
        if len(argv) == 5:
            ...
            led_i = int(argv[4])
            spegniLED()
            accendiSingoloLED(led_i,ROSSO, VERDE, BLU)
            print("Acceso il LED " , led_i)
    print("Arrivato a fine file")
# led.colorWipe(ROSSO, VERDE, BLU)   #Tutte le luci diventano rosse  
# sleep(4)
# spegniLED()
#led .colorWipe(25, 0, 0)   #Tutte le luci diventano rosse 
#     sleep(1.5)
#     # led .colorWipe(0, 25, 0)   # Tutte le luci diventano verdi     
#     # sleep(1.5)
#     # led .colorWipe(0, 0, 25)   # Tutte le luci diventano blu        
#     # sleep(1.5)   
    
#     # led.colorWipe(255,255,255) # Effetto led bianchi perchè sono al massimo dell'intensità

#     # ##### Accensione singolo LED. Ci sono 3 LED per ogni modulo hw
#     led.strip.setPixelColor(2, Color(100, 5, 100))
#     led.strip.show() # necessario per accensione del singolo LED
#     sleep(5)
#     led.strip.setPixelColor(1, Color(100, 42, 0))
#     led.strip.show() # necessario per accensione del singolo LED
#     sleep(5)
#     # led.rainbow()
#     # sleep(2)
#     # led.theaterChaseRainbow(20)
#     # led.rainbow()
#     # ledProva = LED_ctrl()
